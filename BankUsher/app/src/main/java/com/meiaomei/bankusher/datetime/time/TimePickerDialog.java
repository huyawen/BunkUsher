...
package com.meiaomei.bankusher.datetime.time;
...
public class TimePickerDialog extends DialogFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (!mThemeDarkChanged) {
            mThemeDark = DateTimeUtils.isDarkTheme(getActivity(), mThemeDark);
        }
        ...
        timePickerHeader.setBackgroundColor(DateTimeUtils.darkenColor(mAccentColor));
    ...
    private void setCurrentItemShowing(int index, boolean animateCircle, boolean delayLabelAnimate,
        ...
        switch(index) {
            ...
            default:
                ...
                if (announce) {
                    DateTimeUtils.tryAccessibilityAnnounce(mTimePicker, mSelectSeconds);
                }
        ...
        ObjectAnimator pulseAnimator = DateTimeUtils.getPulseAnimator(labelToAnimate, 0.85f, 1.1f);
    ...
    private boolean addKeyIfLegal(int keyCode) {
        ...
        DateTimeUtils.tryAccessibilityAnnounce(mTimePicker, String.format(Locale.getDefault(), "%d", val));
