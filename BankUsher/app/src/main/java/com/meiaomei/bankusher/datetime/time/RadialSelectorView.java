...
public class RadialSelectorView extends View {
    ...
    private static final int SELECTED_ALPHA = DateTimeUtils.SELECTED_ALPHA;
    private static final int SELECTED_ALPHA_THEME_DARK = DateTimeUtils.SELECTED_ALPHA_THEME_DARK;
    // Alpha level for the line.
    private static final int FULL_ALPHA = DateTimeUtils.FULL_ALPHA;
